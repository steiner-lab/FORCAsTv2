...
MODULE cacm3_Integrator

  USE cacm3_Parameters, ONLY: NVAR, NFIX, NSPEC, NREACT, LU_NONZERO
  USE cacm3_Precision
!ddw  USE cacm3_Global
  IMPLICIT NONE
  PUBLIC
  SAVE
...
!ddw  ICNTRL_U, RCNTRL_U, ISTATUS_U, RSTATUS_U, IERR_U )
...
!~~~>   Compute the function at current time
   CALL FunTemplate(T,Y,Fcn0,RCONST, FIX)
...
!~~~>   Compute the Jacobian at current time
   CALL JacTemplate(T,Y,Jac0,FIX, RCONST)
...
Stage: DO istage = 1, ros_S
	 ...
	 Ynew(1:N) = Y(1:N)
         ...
         CALL FunTemplate(Tau,Ynew,Fcn,RCONST, FIX)
         ISTATUS(Nfun) = ISTATUS(Nfun) + 1
...
!~~~> Local variables
   ...
   CALL FunTemplate(T+Delta,Y,dFdT,RCONST, FIX)
   ISTATUS(Nfun) = ISTATUS(Nfun) + 1
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE FunTemplate( T, Y, Ydot, RCONST, FIX)
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!  Template for the ODE function call.
!  Updates the rate coefficients (and possibly the fixed species) at each call
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE cacm3_Parameters, ONLY: NVAR, LU_NONZERO
!ddw USE cacm3_Global, ONLY: FIX, RCONST, TIME
 USE cacm3_Function, ONLY: Fun
!ddw USE cacm3_Rates, ONLY: Update_SUN, Update_RCONST
!~~~> Input variables
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE JacTemplate( T, Y, Jcb ,FIX, RCONST)
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!  Template for the ODE Jacobian call.
!  Updates the rate coefficients (and possibly the fixed species) at each call
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE cacm3_Parameters, ONLY: NVAR, LU_NONZERO
! USE cacm3_Global, ONLY: FIX, RCONST, TIME
 USE cacm3_Jacobian, ONLY: Jac_SP, LU_IROW, LU_ICOL
 USE cacm3_LinearAlgebra
! USE cacm3_Rates, ONLY: Update_SUN, Update_RCONST
!~~~> Input variables
    REAL(kind=dp) :: T, Y(NVAR)
    REAL(kind=dp) :: FIX(NFIX)
    REAL(kind=dp) :: RCONST(NREACT)
